...
**Project work:**
- [ ] **Phase 2:** expand the Lookup database to 500+ items; add Supabase backend; state/municipality regulations. Schema drafted in `DATA_SCHEMA.md` (ranked dispositions). Next build step (in our hands, no outreach): apply Step 1 of its migration path — add a `dispositions[]` array to items in `js/recyclopedia.js`.
